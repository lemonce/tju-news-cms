		...
		<el-main>
			...
			<el-form
				...
				<el-form-item label="thumbnail" prop="thumbnail">
					<el-input type="textarea" v-model="article.thumbnail"></el-input>
				</el-form-item>
				<el-form-item>
			...
			<el-form
				...
				<el-form-item label="catagory">
					<el-checkbox-group v-model="article.catagoryList" @change="test()">
...
export default {
	...
	mounted() {
		...
		axios.get(`/api/tju/service/article/${id}`).then(res => {
